...
class TTGaussianRenderer():
    def __init__(
        self,  
        cfg       
    ):
        self.cfg = cfg#.render
        self.cfg_render = self.cfg.render

    def render(
        self, 
        viewpoint_camera: Camera,
        pc: Union[ToolModel,TissueGaussianModel],
        ...
        override_color = override_color or self.cfg_render.override_color
