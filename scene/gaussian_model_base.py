...
class GaussianModelBase(nn.Module):
    ...
    #     print(f"#points at initialisation for {self.model_name}: ", fused_point_cloud.shape[0])
    ...
    # ttgs related: seems changes a lot
    ...
    def prune_points(self, mask):
        ...
        # ttgs related/changed: contolled prune
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, N=2):
        ...
        #ttgs related (also used in deform3dgs )--differs deform3dgs and 4dgs
        self.scalar_dict['points_split'] = selected_pts_mask.sum().item()
        print(f'#points to split: {selected_pts_mask.sum()}')
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent):
        ...
        # ttgs related (deform3dgs--follow above 'points_split')
        self.scalar_dict['points_clone'] = selected_pts_mask.sum().item()
        print(f'#points to clone: {selected_pts_mask.sum()}')
    ...
    #     if max_screen_size:
    #         # ttgs related/changed: differ from 4dgs
